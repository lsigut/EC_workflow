...
-   \_SSITC: steady state test and test of integral turbulence
    characteristics. This is a typical QC output of `EddyPro`
    (originally named qc_Tau, qc_H, qc_LE, qc_co2_flux) and renamed by
    `correct()` during `WF_1_data_preparation` step.
...
-   summary of `openeddy` and related resources is available as a
    poster: <https://doi.org/10.5281/zenodo.8159040>
